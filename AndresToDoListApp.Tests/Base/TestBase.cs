...
using AndresToDoListApp.Tests.Providers;
using Moq;
...
namespace AndresToDoListApp.Tests.Base
{
    public abstract class TestBase
    {
        ...
        public static Mock<AndresToDoListContext> SetupMockDbContext<T>(Mock<AndresToDoListContext> mockContext, IQueryable set) where T : ToDo
        {
